...
The visiting founder is building a "cursor for games" — an AI-native dev environment for Unity and Unreal, made by [Playco](https://www.play.co/). The argument: 80% of professional games are built in those editors (GDC's 2024–2025 industry surveys actually put combined Unity + Unreal share closer to 64%), and AI coding tools assume you're working on a website. You can point Claude at Unity code, but the editor work — scene setup, asset wiring, prefabs — is still all manual. The result is that the 8-million-strong professional game-dev population (SlashData counts ~11M game devs worldwide, though the figure folds in hobbyists and indies) is years behind the rest of software on AI adoption, partly because game engineers and web engineers barely cross paths.
...
Same story for EVs. [Korea is the most electric country](https://www.koreaherald.com/article/10580014) he's been to outside China. Japan [still has effectively zero electric cars](https://www.jato.com/resources/news-and-insights/japans-automotive-electrification-trends-2025-h1) and was pursuing hydrogen until last year (Japan hasn't fully pivoted — its 2030 plan still includes 1,000 hydrogen stations alongside 150,000 EV chargers, with a target of 12M tons of hydrogen annually by 2040). The really shocking part wasn't the cars — it was the electric scooters, often 30 years old, hot-wired with what look like car batteries, driven by 80-year-olds through red lights with no plates and no police interest. They work. They're quiet. They're ubiquitous. None of it exists in the West.
