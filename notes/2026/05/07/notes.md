...
The architect transplanted the same pattern from his earlier consulting life. The hard problem there wasn't generating insight — it was compressing it into a one-line message a CEO running 10,000 people will accept. Junior analysts drafted, senior managers tore it apart, juniors rewrote. Encode that loop as an agent skill plus a corpus of past approved reports, and you get a storyline reviewer that knows what management will sign off on. No public model has trained on this domain — there's no "writes-like-a-strategy-consultant" benchmark — but the skills/MD pattern lets you fake it locally.
