...
At our AI Breakfast #18, our group of entrepreneurs, developers, consultants, and AI engineers discussed topics ranging from [AI technologies they're grateful for](#ai-technologies-were-grateful-for), [challenges of working with AI in China](#challenges-of-working-with-ai-in-china), and [misinformation in AI](#misinformation-in-ai). The attendees also shared the latest on their work and projects, including [a reading app for kids called Lumi](#lumi-reading-app) and [AI agents for assessing speaking skills in schools from Communication Intelligence Labs](#communication-intelligence-labs-speaking-assessment).
...
- [Voice-to-Text on Mobile Devices](https://support.apple.com/en-us/101624): Built-in feature for dictating text and commands on phones. Attendees appreciated its simplicity for tasks like setting alarms, noting it as an "old school AI" unlock for productivity.
- [Real-Time Translation in Smart Glasses](https://www.rokid.com/en): AR glasses with microphone arrays for subtitling conversations. Used effectively in multilingual settings like offices in China, with praise for accuracy despite some errors.
- [Nano Banana Pro](https://www.nanobananapro.com/): AI image generation tool for creating visuals from prompts. Grateful for enabling non-artists to express ideas, though prompting techniques are needed to avoid default styles.
- [GitHub Copilot](https://github.com/features/copilot): AI-powered coding assistant integrated into development environments. Transformed learning to code, with one attendee crediting it for entering the field after initial hesitation.
- [Vercel V0](https://v0.dev/): Tool for generating UI/UX designs from text descriptions. Helped a developer without design skills create color schemes and layouts quickly, serving as a strong starting point for projects.
- [Microsoft Azure Speech Services](https://azure.microsoft.com/en-us/products/ai-services/speech-to-text): Speech recognition API used in apps for pronunciation analysis. Provided detailed feedback on reading speed and accuracy in the Lumi app, though alternatives like Whisper require additional processing.
- [D-Ocr](https://github.com/hankcs/Doc-OCR): Open-source OCR tool for PDFs, excelling at segmenting images, text, and LaTeX. Best for handling documents with graphs, running affordably on platforms like Hugging Face despite slower speeds for large files.
- [Claude](https://claude.ai/): AI model from Anthropic for various tasks. Valued for productivity but frustrating when inaccessible due to regional blocks, highlighting dependency on such tools.
- [Grok's Rockopedia](https://x.com/grok): AI-generated knowledge base aiming to rebuild Wikipedia iteratively. Seen as impressive for scaling unbiased content, though debates arose on handling controversial topics compared to human-edited sources.
- [AlphaFold](https://deepmind.google/technologies/alphafold/): Protein structure prediction tool from DeepMind. Revolutionized biology by folding all known proteins in a year, exemplifying AI's power to scale human efforts exponentially.
